...
export function dummyPlaces(step: WeddingSteps) {
  console.log('dummyPlaces called with step: ' + step + '');
    ...
    resolve({
      places: [
        ...
        },
        {
          ...
          formatted_address:
            'WWFJ+PR8, Khawlah Bent Al-Azwar St., Amman, Jordan',
        },
        {
        ...
        },
        {
          ...
          name: 'Shatha Halls For Celebrations',
          formatted_address:
        ...
        {
          placeId: 'ChIJJda4y39gGxURHN-LRmZFAlc',
          businessStatus: 'OPERATIONAL',
          location: {
            lat: 31.9753557,
            lng: 35.9577272,
          },
          name: 'Ammon Wedding hall - North Hashmi',
          formatted_address: 'XXG5+43X, Amman, Jordan',
        },
        {
          placeId: 'ChIJZ0aTfNqhHBURH6X6xcK__c8',
          businessStatus: 'OPERATIONAL',
          location: {
            lat: 31.9983957,
            lng: 35.8605166,
          },
          name: 'Al Banafsaj Hall',
          formatted_address: 'Amman, Jordan',
        },
        {
          placeId: 'ChIJXUJw_FFfGxURNvootKQ2cdM',
          businessStatus: 'OPERATIONAL',
          location: {
            lat: 31.9101975,
            lng: 35.9259142,
          },
          name: 'Lotus Wedding Hall',
          formatted_address:
            'Complex No 82 Al Sakhra Al Musharafa St, 82, Amman, Jordan',
        },
      ],
    });
  });
